...
# SUBSTITUA PELO NOME REAL DO ARQUIVO SE NECESSARIO
...
# 4. Adiciona as conexoes limpas (Custo: 75.24 metros)
conexoes = [
    (1, 2), (8, 3), (3, 4), (4, 5), (5, 6), (6, 7), (2, 8),
    (7, 9), (8, 10), (10, 12), (12, 14), (14, 15), (15, 16),
    (2, 19), (8, 20), (8, 21), (14, 22), (16, 23), (9, 24),
    (9, 25), (9, 26), (6, 27), (4, 28)
]
...
plt.title("Rede FTTx (Poda Automática Funcional) - Custo: 75.24m")
